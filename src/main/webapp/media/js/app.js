...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        // handle ajax links
        jQuery('.page-sidebar .sub-menu li > a').on('click', function (e) {
                App.scrollTop();
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            parent.$('#style_color').attr("href", "style/media/css/" + color + ".css");
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el); 
            el.block({
                    message: '<img src="./style/media/image/ajax-loading.gif" align="">',
