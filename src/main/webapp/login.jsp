...
<body class="login">
	...
	<div class="content">
		<form id="form_sample_1" class="form-vertical login-form"
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i> <input class="m-wrap placeholder-no-fix"
							type="text" placeholder="用户名" name="userAccount" />
					</div>
				</div>
			</div>
			<div class="control-group">
	...
	<div class="copyright">2016 &copy; 视频内容发布平台.</div>
